...
if __name__ == "__main__":
    ...
    VIDEO_PATH = r"C:\Users\ShenYuLong\Desktop\water-flow.mp4"
    OUTPUT_VIDEO = r"C:\Users\ShenYuLong\Desktop\water-flow(1).mp4"
    ...
    POINT_LABELS = [1]  # 1=正样本（要分割的对象），0=负样本（排除的区域）
    ...
    print("=" * 50)
    print("SAM3 视频分割 - 文本提示 + 点提示组合版")
    print("=" * 50)
    print(f"\n文本提示: '{PROMPT_TEXT}'")
    print(f"点提示坐标: {POINT_COORDS}")
    print(f"点提示标签: {POINT_LABELS}")
